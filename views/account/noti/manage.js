...
exports.findall = function(req, res, next){
        ...
        req.app.db.models.Noti.pagedFind({
            ...
            results.filters = req.query;
            res.render('account/noti/manage', { data: results.data.reverse() });
            }
        });
};
...
exports.editinit = function(req, res, next){
        ...
        req.app.db.models.Noti.findById(req.params.id).exec(function(err, result) {
            ...
            res.send(noti);
                ...
                console.log(result);
                res.render('account/noti/edit',{persons:persons,noti:result});
            }
        });
...
exports.delete = function(req, res, next){
    ...
    req.app.db.models.Noti.findByIdAndRemove(req.params.id, function(err, account) {
        if (err) {
        return workflow.emit('exception', err);
        }
